...
**
** Created: Fri Apr 19 14:24:01 2013
...
public:
    ...
    void setupUi(QMainWindow *ShareCameraQt)
    {
        ...
        groupBox_5->setGeometry(QRect(60, 40, 351, 161));
        ...
        widget->setGeometry(QRect(430, 70, 91, 101));
        ...
        dockWidget = new QDockWidget(ShareCameraQt);
